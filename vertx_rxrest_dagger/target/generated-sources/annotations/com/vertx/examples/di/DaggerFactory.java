...
import com.vertx.examples.routers.StudentRouter_Factory;
import com.vertx.examples.routers.StudentRouter_MembersInjector;
...
public final class DaggerFactory implements Factory {
  ...
  private StudentController injectStudentController(StudentController instance) {
    StudentController_MembersInjector.injectStudentService(
        instance, StudentService_Factory.newStudentService());
    return instance;
  }
